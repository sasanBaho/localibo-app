...
const TABS: Tab[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Allow Localibo", detail: 'Find localibo.ca in the list and change it to "Allow". If it is not listed, set "When visiting other websites" to "Ask" or "Allow".' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Reload the page", detail: "Go back to Safari, refresh the Localibo page, and try again." },
    ],
    note: 'If Localibo.ca already has a blocked entry under Location Services, tap it directly and change it to "Allow".',
  },
  {
    id: "firefox",
    label: "Firefox",
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Reload the page", detail: "Go back, refresh the Localibo page, and try again." },
    ],
  },
];
          ...
          return (
            <button
              ...
              style={{
                ...
                padding: "8px 14px",
                borderRadius: 999,
                border: isActive ? "2px solid #a393c9" : "1.5px solid #e5e7eb",
